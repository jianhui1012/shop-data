...
# Database: shareshop
# Generation Time: 2022-09-01 10:15:23 +0000
# ************************************************************
...
CREATE TABLE `t_borrow_record` (
  ...
  `start_time` date DEFAULT NULL COMMENT '借用时间',
  `end_time` date DEFAULT NULL COMMENT '归还时间',
...
INSERT INTO `t_borrow_record` (`id`, `borrow_user_id`, `goods_id`, `start_time`, `end_time`, `borrow_status`, `shop_id`, `refuse_reason`, `username`, `phone`)
VALUES
	(1,1,'1','2022-08-09','2022-09-29',1,NULL,NULL,NULL,NULL);
...
CREATE TABLE `t_goods` (
  ...
  `borrowCount` bigint(20) NOT NULL COMMENT '已借出数量',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
VALUES
	(1,'超级管理员','所有权限','[19,27,30,24,38,39,2,40,3]'),
	(2,'普通用户','部分权限','[]');
