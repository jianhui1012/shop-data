...
public class BorrowRecord extends Model<BorrowRecord> {
     ...
     * 借用者姓名
     */
    @ApiModelProperty(value = "借用者姓名")
    private String username;

    /***
     * 借用者手机
     */
    @ApiModelProperty(value = "借用者手机")
    private String phone;

    /**
      * 物品编号 
      */
    @ApiModelProperty(value = "物品编号，多个的话以逗号分隔，比如：1,2,3...")
    ...
    /**
      ...
      */
    @ApiModelProperty(value = "借用状态, 1-已借用，2-已归还 3-申请借用,等待店铺老板同意 0-默认")
